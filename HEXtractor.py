#!/usr/bin/env python3
"""
HEXtractor.py - Unified OS partition extractor for Symbol HEX and BGZ images.

Handles both image formats:
...
def main():
    ...
    parser.add_argument('--input', required=True,
                        help='Source image: .hex (Symbol HEX) or .bgz (gzip NK.bin)')
    ...
    fmt = 'bgz' if input_path.suffix.lower() == '.bgz' else 'hex'
